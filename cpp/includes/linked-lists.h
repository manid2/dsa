...
inline NodePtr new_node(int data) {
...
// Helper functions
inline void append(NodePtr &tail, int data) {
...
inline NodePtr copy(NodePtr node) {
...
inline NodePtr copy(const vector<int> &v) {
...
inline string to_string(NodePtr node) {
  ostringstream oss;
  oss << node;
  return oss.str();
}
